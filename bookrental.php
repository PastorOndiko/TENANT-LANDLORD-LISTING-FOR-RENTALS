...
<header>
  ...
  <footer class="py-3 my-4">
    ...
    <button type="button" class="btn btn-success"> <li class="nav-item"><a href="tenant.php" class="nav-link px-2 font-weight-bold">Home</a></li></button>
      <button type="button" class="btn btn-info"><li class="nav-item"><a href="bookrental.php" class="nav-link px-2 text-muted">Book</a></li></button>
      <button type="button" class="btn btn-danger"><li class="nav-item"><a href="searchrental.php" class="nav-link px-2 text-muted">Search</a></li></button>
      
      <button type="button" class="btn btn-warning"><li class="nav-item"><a href="profile.php" class="nav-link px-2 text-muted">Profile</a></li></button>
    ...
    if (isset($_SESSION["user_id"])) {
        ...
        if (isset($_GET["listing_id"])) {
            ...
            if ($listing) {
                ...
                echo '<button type="button" class="btn btn-primary"><input type="submit" name="book" value="Book Rental"></button>';
