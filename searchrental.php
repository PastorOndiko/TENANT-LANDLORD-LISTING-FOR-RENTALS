...
<header>
  ...
  <footer class="py-3 my-4">
    ...
    <button type="button" class="btn btn-success"> <li class="nav-item"><a href="tenant.php" class="nav-link px-2 text-muted">Home</a></li></button>
    ...
    if (isset($_SESSION["user_id"])) {
        ...
        if (count($listings) > 0) {
            ...
            foreach ($listings as $listing) {
                ...
                echo '<a href="bookrental.php?listing_id=' . $listing["id"] . '" class="btn btn-success">Book Rental</a>';
